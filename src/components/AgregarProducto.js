       ...
       <Container>
           <Form className='my-5' onSubmit={handleSubmit}>
               ...
               <Form.Group>
                   ...
                   <Form.Control type='number' placeholder='0'  onChange={(e) => setPrecioProducto(e.target.value)}></Form.Control>
               </Form.Group>
               <h3 className='text-center my-4'>Categoria</h3>
               <div className='text-center'>
                   <Form.Check type='radio' name='categoria' inline label='Bedida Caliente'value='caliente' onChange={cambioCategoria}></Form.Check>
                   <Form.Check type='radio' name='categoria' inline label='Bedida Fria' value='fria' onChange={cambioCategoria}></Form.Check>
